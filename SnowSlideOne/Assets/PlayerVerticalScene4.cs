...
public class PlayerVerticalScene4 : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        if (Vert.GetComponent<EndCheckVertScene4>().VertReachEnd == false)
        {
            if (UITEXT.GetComponent<DialogueScene2>().MoveActive == true || SceneManager.GetActiveScene().buildIndex == 5)
            {
